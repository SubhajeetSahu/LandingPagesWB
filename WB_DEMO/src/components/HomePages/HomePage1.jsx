            ...
            <div className="col-md-3 mb-4">
              <div className="card card-gradient-all-users card-gradient">
                <div className="card-body-home">
                  ...
                  <p className="card-text-home">{allUsers}</p> {/* Placeholder data */}
                </div>
              </div>
            </div>
            <div className="col-md-3 mb-4">
            ...
            <div className="col-md-3 mb-4">
              <div className="card card-gradient-companies card-gradient">
                <div className="card-body-home">
                  ...
                  <p className="card-text-home">{companies}</p> {/* Placeholder data */}
                </div>
              </div>
            </div>
            <div className="col-md-3 mb-4">
              <div className="card card-gradient-suppliers card-gradient">
                <div className="card-body-home">
                  ...
                  <p className="card-text-home">{suppliers}</p> {/* Placeholder data */}
                </div>
              </div>
            </div>
            <div className="col-md-3 mb-4">
              <div className="card card-gradient-customers card-gradient">
                <div className="card-body-home">
                  ...
                  <p className="card-text-home">{customers}</p> {/* Placeholder data */}
                </div>
              </div>
            </div>
          </div>
